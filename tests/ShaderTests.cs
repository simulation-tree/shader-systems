...
namespace Shaders.Tests
{
    public class ShaderTests
    {
        ...
        public void CompileGLSLToSPV()
        {
            ...
            Assert.That(shader.UniformProperties.Length, Is.EqualTo(3));
            var spriteInfo = shader.UniformProperties[0];
            ...
            var transformInfo = shader.UniformProperties[1];
            ...
            var cameraInfo = shader.UniformProperties[2];
